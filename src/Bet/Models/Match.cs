...
namespace Bet
{
    internal class Match
    {
        ...
        public int? AbsoluteMargin => Margin is null
            ? Margin
            : Math.Abs((int)Margin);
        ...
        public double Team1ImpliedProbabilityInclVigorish
            => Team1Odds.ToImpliedProbability();

        public double Team2ImpliedProbabilityInclVigorish
            => Team2Odds.ToImpliedProbability();

        public double DrawImpliedProbabilityInclVigorish
            => DrawOdds.ToImpliedProbability();
        ...
        public double Team1ImpliedProbabilityExclVigorish
            => (100d / TotalImpliedProbabilityInclVigorish) * Team1ImpliedProbabilityInclVigorish;

        public double Team2ImpliedProbabilityExclVigorish
            => (100d / TotalImpliedProbabilityInclVigorish) * Team2ImpliedProbabilityInclVigorish;

        public double DrawImpliedProbabilityExclVigorish
            => (100d / TotalImpliedProbabilityInclVigorish) * DrawImpliedProbabilityInclVigorish;
        ...
        public bool IsWinnerPredictionCorrect()
        {
